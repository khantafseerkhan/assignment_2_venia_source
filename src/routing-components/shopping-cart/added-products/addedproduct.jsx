...
const Addedproduct = (props) => {
    ...
    let productData = useSelector(state => state.updateCartProduct.cartProduct);
            ...
            return (
                ...
                <div className="aem-GridColumn aem-GridColumn--default--7 aem-GridColumn aem-GridColumn--tablet--9 aem-GridColumn aem-GridColumn--phone--9">
                    ...
                    <div className="aem-Grid aem-Grid--12">
                        <div className="aem-GridColumn aem-GridColumn--default--6 aem-GridColumn aem-GridColumn--tablet--10 aem-GridColumn aem-GridColumn--phone--10 details">
                ...
                <div className="aem-GridColumn aem-GridColumn--default--2  aem-GridColumn aem-GridColumn--tablet--1 aem-GridColumn aem-GridColumn--phone--1 edit-section">
                   <ul>
                    <li>
                        <a href="#"><img src={require("../../../assets/img/edit-2.png")} /> <span>Edit item</span></a>
                    </li>

                    <li>
                        <a onClick={()=>removeproduct(index)}><img src={require("../../../assets/img/trash-2.png")}  /> <span>Remove</span></a>
                    </li>


                    <li>
                        <a href=""><img src={require("../../../assets/img/heart.png")}/> <span>Save for later</span></a>
                    </li>
                    </ul>
                </div>
